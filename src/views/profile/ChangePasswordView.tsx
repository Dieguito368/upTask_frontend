...
import { UpdateCurrentUserPasswordFormData } from "@/types/index";
...
export default function ChangePasswordView() {
    ...
    const handleChangePassword = (formData: UpdateCurrentUserPasswordFormData) => mutate(formData);
        ...
        <>
            <div className="mx-auto max-w-3xl">
                ...
                >
                    <div className="mb-5">
                        <label
                            className="text-sm uppercase font-bold block mb-3"
                        ...
                        { errors.current_password && <Error>{errors.current_password.message}</Error> }
                    </div>
