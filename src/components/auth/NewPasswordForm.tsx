...
import type { ConfirmToken, NewPasswordFormData } from "../../types";
        ...
        <>
            ...
            >
                ...
                <input
                    ...
                    className="bg-fuchsia-600 hover:bg-fuchsia-700 w-full p-3 text-white font-black text-sm cursor-pointer"
                />
            </form>
        </>
    )
