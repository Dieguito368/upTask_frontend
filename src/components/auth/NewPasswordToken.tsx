        ...
        <>
            ...
            >
                ...
                <div className="flex justify-center gap-5">
                    <PinInput value={ token } onChange={ handleChange } onComplete={ handleComplete }>
                        <PinInputField className="h-10 w-10 p-3 rounded-lg border-gray-300 border placeholder-white outline-fuchsia-500" />
                        <PinInputField className="h-10 w-10 p-3 rounded-lg border-gray-300 border placeholder-white outline-fuchsia-500" />
                        <PinInputField className="h-10 w-10 p-3 rounded-lg border-gray-300 border placeholder-white outline-fuchsia-500" />
                        <PinInputField className="h-10 w-10 p-3 rounded-lg border-gray-300 border placeholder-white outline-fuchsia-500" />
                        <PinInputField className="h-10 w-10 p-3 rounded-lg border-gray-300 border placeholder-white outline-fuchsia-500" />
            ...
            <nav className="mt-10 flex flex-col space-y-4">
                <Link
                    ...
                    className="text-center text-gray-300 font-light hover:text-gray-50 transition-colors"
                >
