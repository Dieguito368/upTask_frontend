...
const NavMenu = ({ name } : NavMenuProps) => {
    ...
    return (
        <Popover className='relative'>
            <PopoverButton className='inline-flex items-center gap-x-1 text-sm font-semibold leading-6 p-1 rounded-lg bg-purple-400 outline-none'>
